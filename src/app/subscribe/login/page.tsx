...
export default function SubscribeLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/subscribe/dashboard');
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Subscriber Login</h2>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Access your subscription dashboard</p>
        </div>
        ...
        <motion.form
          ...
          className="bg-white dark:bg-gray-800/50 backdrop-blur-lg rounded-xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700"
        >
          {error && (
            <motion.div
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <a href="/subscribe/signup" className="text-blue-600 hover:text-blue-500 font-medium">
                Subscribe here
              </a>
            </p>
          </div>
